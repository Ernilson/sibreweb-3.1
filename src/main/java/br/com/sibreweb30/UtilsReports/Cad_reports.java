 ...
 */
@Service
public class Cad_reports implements ReportService {
    ...
    public boolean creatPdf(List<CadModel> cad, ServletContext context, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Logger.getLogger(CadServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
    ...
    @Override
    public boolean createExcel(List<CadModel> cad, ServletContext context, HttpServletRequest request, HttpServletResponse response) {
        String filePath = context.getRealPath("/resources/reports");
        File file = new File(filePath);
        boolean exists = new File(filePath).exists();
        if (!exists) {
        ...
        try {
//            FileOutputStream outputStream = new FileOutputStream(file + "/"cad"+".xls);
//HSSFOWorkbook workbook = new HSSFWorkbook();
//            HSSFSheet workSheet = workbook.createSheet("Cadastro");
